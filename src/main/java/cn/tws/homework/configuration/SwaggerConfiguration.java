package cn.tws.homework.configuration;

import cn.tws.homework.swagger.SwaggerDocketFactory;
...
public class SwaggerConfiguration {
    private static final String CONTROLLER_PACKAGE = "cn.tws.homework";
